...
*   **Total Cost Thresholds**: Meetings costing over ₹10,000 trigger a `WARN` flag, prompting organizers to reconsider the attendee list.
*   **Agenda Hygiene**: For meetings costing over ₹5,000, the provided agenda is strictly analyzed. If it lacks strong action verbs (e.g., *decide, resolve, approve, vote*), the meeting is flagged as a `REJECT`. This prevents expensive, unstructured status updates that could simply be an email.
